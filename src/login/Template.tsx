...
import bgJpgUrl from "./assets/img/login-bg-sign-1.jpg";
                    ...
                    <header className={kcClsx("kcFormHeaderClass")}>
                        ...
                        {(() => {
                            const node = !(auth !== undefined && auth.showUsername && !auth.showResetCredentials) ? (
                                <div>
                                    <div id="kc-header-logo" className={kcClsx("kcLogoClass")}>
                                        <img src={logoPngUrl} alt={realm.displayNameHtml} width={75} />
                                    </div>
