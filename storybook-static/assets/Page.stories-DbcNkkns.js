import{t as e}from"./KcPageStory-BtlMbT4_.js";var t={url:{loginAction:`/login-action`},idpAlias:`mockIdpAlias`},{KcPageStory:n}=e({pageId:`login-idp-link-confirm.ftl`}),r={title:`login/login-idp-link-confirm.ftl`,component:n},i={args:{kcContext:t}},a={args:{kcContext:{locale:{currentLanguageTag:`ar`,rtl:!0}}}},o={args:{kcContext:{locale:{currentLanguageTag:`fr`}}}},s={args:{kcContext:{...t,url:{loginAction:`/error`},message:{type:`error`,summary:`An error occurred during form submission.`}}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
